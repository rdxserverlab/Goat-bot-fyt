process.stdout.write("]2;Goat Bot V2 - Made by NTKhang Fixed by BaYjid\\");
...
async function startBot(_0x141d2f) {
  ...
  (function _0x23fdc7(_0x221140) {
    ...
    login({
      ...
      let _0x1548d1;
      try {
        const _0x2c1b20 = await axios.get("https://raw.githubusercontent.com/BAYJID-404-BOYZ/public/refs/heads/main/notification.txt");
